<template>
  ...
  >
    ...
    <ul class="main-layout layout-grid">
      ...
      <li
        v-bind:style="boxlayout ? '' : 'display: none;'"
        data-attr="box"
    ...
    <ul class="sidebar-setting layout-grid">
      <li class="active" data-attr="stroke-svg">
        ...
        <div class="body bg-light">
          <span class="badge badge-primary" @click="customSvg('stroke-svg')"
            >Stroke</span
          >
        </div>
      </li>
      <li data-attr="fill-svg">
        ...
        <div class="body bg-light">
          <span class="badge badge-primary" @click="customSvg('fill-svg')"
            >Fill</span
          >
        </div>
      </li>
    ...
    <ul class="layout-grid unlimited-color-layout">
      <input
        id="ColorPicker1"
        type="color"
        :value="primary || `#ed1b24`"
        name="Background"
      />
      <input
        id="ColorPicker2"
        type="color"
        :value="secondary || `#f73164`"
        name="Background"
      />
      <button
...
export default {
  ...
  methods: {
    ...
    resetColor() {
      localStorage.setItem("primary_color", "#ed1b24");
